...
import org.wso2.identity.integration.test.rest.api.server.email.template.v2.model.EmailTemplateTypeWithID;
import org.wso2.identity.integration.test.rest.api.server.email.template.v2.model.EmailTemplateTypeWithoutTemplates;
...
public class EmailTemplatesPositiveTest extends EmailTemplatesTestBase {
    ...
    public void init() throws IOException {
        ...
        String expectedResponse = readResource("get-all-email-template-types-response-v2.json");
        ...
        expectedResponse = readResource("get-email-template-type-response-v2.json");
        ...
        expectedResponse = readResource("get-templates-list-of-email-template-type-response-v2.json");
        jsonWriter = new ObjectMapper(new JsonFactory());
        ...
        expectedResponse = readResource("add-email-template-request-v2.json");
        jsonWriter = new ObjectMapper(new JsonFactory());
        getSpecificEmailTemplateResponse = jsonWriter.readValue(expectedResponse, EmailTemplateWithID.class);

        // Init getEmailTemplate method response
        expectedResponse = readResource("add-application-email-template-request-v2.json");
        jsonWriter = new ObjectMapper(new JsonFactory());
    ...
    public void testAddEmailTemplateType() throws IOException {
        ...
        String body = readResource("add-email-template-type-request-v2.json");
    ...
    public void testAddEmailTemplate() throws IOException {
        ...
        String body = readResource("add-email-template-request-v2.json");
    ...
    public void testAddApplicationEmailTemplate() throws IOException {
        ...
        String body = readResource("add-application-email-template-request-v2.json");
        String path = EMAIL_TEMPLATES_API_BASE_PATH + EMAIL_TEMPLATE_TYPES_PATH + PATH_SEPARATOR +
    ...
    public void testUpdateEmailTemplate() throws IOException {
        ...
        String body = readResource("update-email-template-request-v2.json");
        String path = EMAIL_TEMPLATES_API_BASE_PATH + EMAIL_TEMPLATE_TYPES_PATH + PATH_SEPARATOR +
    ...
    public void testUpdateApplicationEmailTemplate() throws IOException {
        ...
        String body = readResource("update-application-email-template-request-v2.json");
        String path = EMAIL_TEMPLATES_API_BASE_PATH + EMAIL_TEMPLATE_TYPES_PATH + PATH_SEPARATOR +
    ...
    @Test(dependsOnMethods = {
            "testUpdateApplicationEmailTemplate",
            "EmailTemplatesNegativeTest.testAddConflictingApplicationEmailTemplate"
    })
    ...
    public void testUpdateEmailTemplateType() throws IOException {
        ...
        String body = readResource("update-email-template-type-request-v2.json");
        String path = EMAIL_TEMPLATES_API_BASE_PATH + EMAIL_TEMPLATE_TYPES_PATH + PATH_SEPARATOR +
                templateTypeId;
        getResponseOfPut(path, body).then()
                .log().ifValidationFails()
        ...
        EmailTemplateTypeWithID expectedResponse =
                jsonWriter.readValue(readResource("updated-email-template-type-response-v2.json"),
